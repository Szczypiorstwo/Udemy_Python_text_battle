...
class Person:
    ...
    def enemy_get_stats(self):
        ...
        while bar_ticks > 0:
            ...
            bar_ticks -= 1
        while (len(hp_bar)/10) < 25:
            hp_bar += bcolors.WARNING + "█" + bcolors.ENDC
        ...
        print(bcolors.BOLD + self.name + " " + current_hp + " |" + hp_bar + "|")
    ...
    def get_stats(self):
        ...
        while (len(mp_bar) / 10) < 10:
            mp_bar += bcolors.WARNING + "█" + bcolors.ENDC
        ...
        print(bcolors.BOLD + self.name + "        " + current_hp + " |" + hp_bar + "|    " + current_mp + "    |" + mp_bar + "|")


    def choose_enemy_spell(self):
        magic_choice = random.randrange(0, len(self.magic))
        spell = self.magic[magic_choice]
        magic_dmg = spell.cost

        pct = self.hp / self.maxhp * 100

        if self.mp < magic_dmg or (spell.type == "white" and pct > 50):
